...
<head>
    ...
    <link href={{asset('asset/dist/css/styles.css')}} rel="stylesheet"/>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="index.html">Sewa Kamera Online</a><button
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    ...
                    <a class="nav-link collapsed" href="{{url('/kamera')}}" data-toggle="collapse" data-target="#collapseLayouts"
                            aria-expanded="false" aria-controls="collapseLayouts">
                            <div class="sb-nav-link-icon"><i class="fas fa-camera"></i></div>
                            Data Kamera dan Asesoris
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
                        <a class="nav-link collapsed" href="{{url('/karyawan')}}" data-toggle="collapse" data-target="#collapsePages"
    ...
    <script src={{asset('asset/dist/assets/demo/chart-area-demo.js')}}></script>
    <script src={{asset('asset/dist/assets/demo/chart-bar-demo.js')}}></script>
    <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
    <script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
    <script src={{asset('asset/dist/assets/demo/datatables-demo.js')}}></script>
</body>
